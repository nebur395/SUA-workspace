...
public class TrafficJamDetectedRule extends AdaptationRule {

	private BundleContext context;
	private Dictionary<String, Object> properties = null;
	public TrafficJamDetectedRule(BundleContext context) {
		super(context);
		this.context = context;
		this.properties = new Hashtable<String, Object>();
		properties.put("rt", EMonitorRT.TrafficJamDetected);
		...
		try {
			...
			if(level == 3) {
				...
				if(arc_SAE_L3_TrafficJamChauffer != null) {
					servicesList.add(arc_SAE_L3_TrafficJamChauffer);
				}				
			}
